export const catalog = [
  ...
  }, 
  {
    ...
    fullname: "Port Authority® Tall Wearever Signature Pique Pocket Polo (TLK200P)",
    colors: ["Deep Black","Gusty Grey","Storm Grey","True Royal"],
    type: "mens",
    default_color: "Deep Black",
    sizes: {
  ...
  },
  {
    ...
    fullname: "Clear Reflective Shopper Tote Bag w/black imprint (black handles) ",
    description: "12 in. x 12 in. x 6 in.",
    colors: ["Clear"],
    type: "accessory",
    default_color: "Clear",
    description: "Sold in quantities of 250, 500 and 1000; Enter '1' for shipment of 250 bags, etc.",    
    sizes: {
       "250": 4.99,
       "500": 4.99,
       "1000": 4.99,       
  ...
  },  
  {
    ...
    description: "Box - silver foil; Pen - black; Fob - black leather/white stitch, black color fill",
    colors: ["Black"],
    type: "accessory",
    default_color: "Black",
    description: "Sold in quantities of 250, 500 and 1000; Enter '1' for shipment of 250 boxsets, etc.",    
    sizes: {
       "250": 8.99,
       "500": 8.99,
       "1000": 8.99,       
  ...
  },
  {
    ...
    type: "accessory",
    default_color: "Black",
    description: "Sold in quantities of 250; Enter '1' for shipment of 250 tumblers.",    
    sizes: {
       "250": 12.99,       
   },
  },  
  {
    ...
    type: "sales",
    default_color: "Black", 
    description: "Sold in quantities of 10, 50 and 100 packs. Enter '1' for a shipment of 10 packs, etc.",    
    sizes: {
       10: 4.50,
       50: 4.00, 
       100: 3.50,        
  ...
  },
  {
    ...
    fullname: "8.5 x 11 Blank Vinyl Sheet, Outside Vehicle (100 per pack) #9300",
    colors: ["White"],
    type: "sales",
    default_color: "White",    
    sizes: {
