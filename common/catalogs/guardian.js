export const catalog = [
  ...
  },
  {
    code: "LPC61",
    name: "Port & Company® Tee",
    fullname: "Port & Company® Women's Essential Tee",
    colors: ["Athletic Maroon","Candy Pink","Charcoal","Jet Black","Red"],
    type: "womens",
    default_color: "Jet Black",
    sizes: {
      Small: 0.00,
  ...
  },
  {
    ...
    colors: ["Black","Cardinal","Carolina Blue","Grey Concrete","Iron Grey","Kelly Green","True Navy","White"],
    type: "womens",
    default_color: "Black",
    sizes: {
      Small: 0.00,
